...
var aPropriedade = 'fabricacao';
meuCarro[aPropriedade] = "Wolks";//mudei ford para wolks
var bPropriedade = "ano";
meuCarro[bPropriedade] = 1971;

//usando for in para iterar
function mostrarProps(meuCarro, meuCarro) {
  var resultado = "";
